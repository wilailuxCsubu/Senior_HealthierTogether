...
public class Home_assessment3 extends Home_assessment {
//
//    int result3;
//    Button btn ;
//    RadioButton ch0,ch1,ch2,ch3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = Toast.makeText ( Home_assessment3.this, "result =  " + sum +"\n" +
       ...
       radioGroup = (RadioGroup) findViewById(R.id.gch);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast toast = Toast.makeText ( Home_assessment3.this, "กรุณากรอกข้อมูล" , Toast.LENGTH_LONG );
                    toast.show ( );
                }
                else {
                    Choice();
