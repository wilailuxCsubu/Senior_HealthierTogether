    ...
    <div class="col-sm-3">
      <div class="card mb-3">
        ...
        <form  method="post" action="form_genogram.php">
                      ...
                      <label for="gewicht2"class="col-sm-5 control-label">Name</label>
                      <input type = "text" class = "form-control" name= "name">
                      <p></p>
                      <label for="gewicht2"class="col-sm-5 control-label">ag</label>
                      <input type = "number" class = "form-control" name= "ag">
                      <p></p>
                      <label for = "lengte2" class="col-sm-5 control-label">Mom</label>
                      <input type = "number" class = "form-control" name= "mom">
                      <p></p>
                      <label for = "lengte2" class="col-sm-5 control-label">Father</label>
                      <input type = "number" class = "form-control" name= "fater">
                      <p></p>
                      <label for = "lengte2" class="col-sm-5 control-label">marry</label>
                      <input type = "number" class = "form-control"  name= "ux">
                      <p></p><br>
                      ...
                      <p></p><br>
                      <button class = "btn btn-warning" type = "button" onclick="myFunction()">รีเซ็ต</button><br><br>
                       <button class = "btn btn-warning" type = "submit" id = "submit">ยืนยัน</button>
                  </form>
