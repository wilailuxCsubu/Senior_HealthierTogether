...
<body>
    ...
    ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
              ...
              <br><br>
                ...
                <div class="row">
                     &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            <a role="button" class="btn btn-primary btn-lg" href="Edit_genogram.php?HN=<?php echo $HN;?>">
      ...
      include "config.php";
      $objConnect = mysqli_connect($servername, $username, $password, $database)or die("Error Connect to Database");
      $strSQL = "SELECT * From genogram WHERE id = '".$id."' ";
      $objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
      $result=mysqli_fetch_array($objQuery,MYSQLI_ASSOC);
      ...
      ?>
        ...
        <div class="row" style="font-size:17px">
            <div class="form-group col-md-10">
                ...
                <input type="hidden" name="fig" value="<?echo $result["fig"];?>"/>
           
              </div>

          <div class="form-group col-md-10" >
          <label for = "man"></label>เพศ : &nbsp;&nbsp;
          <input type="hidden" name="sex" value="<?echo $result["sex"];?>"/>
           <?php
           $sex = $result["sex"];
              if ($result["fig"] =="1"){
                  if($sex=='M'){
                  ...
                  echo "<input type ='text' name ='sex' class='form-control' value =$sex disabled/>";
              ?>
            <?  }else{ ?>
        ...
        <div class="row">
          <div class="form-group col-md-7 ">
            ...
            <input type = "text" class = "form-control" name= "nameShow" value = "<?echo $result["name"];?>"  
            <?php if ($result["fig"] =="1") echo "disabled";?> />
            <input type="hidden" name="name" value = "<?echo $result["name"];?>" />
          </div>
          <div class="form-group col-md-3">
            <label for="message-text" class="form-control-label">ปีที่เกิด :</label>
            <input type="hidden" name="byear" value = "<?echo $result["byear"];?>" />
              <?php
              $myDate = $result['byear'];
              if ($result["fig"] =="1"){
                  echo "<input type='text' value=$myDate disabled class='form-control'/>";
              }else{
