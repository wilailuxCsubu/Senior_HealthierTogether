...
<head>
  ...
  $HN = $_GET['HN'];
   ...
   if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    $sql = "SELECT * FROM genogram WHERE familyID ='".$HN."' ";
                ...
                <div class="col-lg-12">
                  <br>  <br>
                    <div class="col-md-12">
                      ...
                      <li ><a href="profile_p.php?HN=<?php echo $HN ?>" >ข้อมูลประวัติ</a>
                      </li>
                      <li class="active"><a href="genogram.php?HN=<?php echo $HN;?>">ผังครอบครัว</a>
                      </li>
...
<div class="modal fade bd-example-modal-xl" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body"> 
      <form method="post" action="form_genogram.php">
        <div class="row" style="font-size:17px">
            <input type="hidden" name ="familyID" id="disabledInput" value = "<?php echo $HN ?>" />
            
        <div class="form-group col-md-12" >
            <div class="row">
                <div class="form-group col-md-6">
                  <p>กรณีที่สมาชิกในครอบครัวมีรหัส HN : </p> 
                  <input type = "text" name ="" id = "" value = "" class = "form-control"/>
                  <button type="button" class="btn btn-outline btn-primary btn-md" >
        ...
        $strSQL = "SELECT * From genogram WHERE sex ='M' AND familyID = '$HN' ";
        ...
        $strSQL = "SELECT * From genogram WHERE sex ='F' AND familyID = '$HN'";
          $objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]")
          ?>
      ...
      include "config.php";
      $objConnect = mysqli_connect($servername, $username, $password, $database)or die("Error Connect to Database");
      $strSQL = "SELECT MAX(key_no) AS no FROM genogram WHERE familyID = '$HN'  ";
      $objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
      $result=mysqli_fetch_array($objQuery,MYSQLI_ASSOC);
    ?>
         <!--<h2><?php echo $result["no"]; ?></h2>-->
         <input type="hidden" name ="no" value = "<?php echo $result["no"]+1; ?>" />
  ...
  <?
      ...
      include "config.php";
      $objConnect = mysqli_connect($servername, $username, $password, $database)or die("Error Connect to Database");
      $strSQL = "SELECT CONCAT(Name,' ',Last) AS name_p From patient WHERE HN = '".$HN."' ";
      $objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
      $result=mysqli_fetch_array($objQuery,MYSQLI_ASSOC);
    ...
    ?>
            ...
            <div class="row">
              ...
              <br>
              <center>
                  <h3>ผังครอบครัวของ <?php echo $result["name_p"];?> </h3>
              </center><br>
                <center>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a role="button" class="btn btn-outline btn-warning btn-lg" href="Edit_genogram.php?HN=<?php echo $HN ?>">
