            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                          <form action="profile_A.php" method="post">
                ...
                ?>
                                <tbody >
                                    <tr >
                                      ...
                                      <td><input name="name" href="profile_A.php?userID=<?php echo $objResult["userID"];?>" class="btn btn-outline btn-warning" type="submit" value="<?php echo $objResult["name_a"];?>" style="font-size:17px"></td>
        ...
        <div class="modal-body">
          <form method="post" action="form_a.php">
              ...
              <div class="form-group col-md-6 ">
                <label for="recipient-name" class="form-control-label">ชื่อผู้ใช้:</label>
