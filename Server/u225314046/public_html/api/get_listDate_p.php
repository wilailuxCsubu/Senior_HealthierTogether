...
include "config.php";
  ...
  $con = mysqli_connect($servername, $username, $password, $database) or die('Unable to Connect'); //ต่อฐานข้อมูล
	...
	mysqli_set_charset($con,"utf8");
		...
		$sql = "SELECT MakeDate.date ,MakeDate.HN,patient.img ,CONCAT(patient.Name,' ',patient.Last) AS name_p 
		    From MakeDate
            INNER JOIN patient ON patient.HN = MakeDate.HN 
            WHERE MakeDate.HN = '".$strHN."' ORDER BY MakeDate.date ASC
            ";
