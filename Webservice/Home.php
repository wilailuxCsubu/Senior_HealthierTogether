      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion"><br>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts" style="font-size:18px">
          <a class="nav-link" href="mysick.php">
            ...
            <span class="nav-link-text">สรุปรายงานผล</span>
          </a>
        </li>
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-12 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5" >ไม่เป็นภาระเพิ่งพา</div>
            </div>
        ...
        <div class="col-xl-3 col-sm-12 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa fa-blind"></i>
              </div>
              <div class="mr-5">ภาระเพิ่งพาปานกลาง</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
        ...
        <div class="col-xl-3 col-sm-12 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">ภาระพึ่งพารุนแรง!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
        ...
        <div class="col-xl-3 col-sm-12 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">ภาระพึ่งพาโดยสมบูรณ์!!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
